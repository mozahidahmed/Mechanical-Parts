...
const BussnesSummary = () => {
    ...
    return (
      <div className="mt-12 bg-[#FFC73B] rounded-xl">
        <h1 className="text-3xl text-center text-white py-6 font-bold">
          BUSSENESS <span className="text-black">SUMARY</span>
        </h1>

        <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 py-6  mx-12 justify-center">
          {/* .................................................................... */}
